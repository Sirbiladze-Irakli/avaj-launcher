...
public class Helicopter extends Aircraft implements Flyable {
	...
	private int[] positionInSun = new int[]{10, 0, 2};
	private int[] positionInRain = new int[]{5, 0, 0};
	private int[] positionInFog = new int[]{1, 0, 0};
	private int[] positionInSnow = new int[]{0, 0, -12};
